...
ggplot(dayMeans) + 
  geom_point(aes(x = RpoS, y = meanAcrossDays), width=10, size=0.5) + 
  geom_errorbar(aes(x = RpoS, y = meanAcrossDays, ymax = upperErrorBar, ymin = lowerErrorBar), width=10, size=0.5) + 
  facet_grid(.~strain)
